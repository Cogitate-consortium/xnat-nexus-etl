...
def main():
    ...
    field_list = "research_study_id, xnat_custom_fields, research_study_uri"
    ...
    for index, subject in subject_df.iterrows():
        ...
        df = recursive_creation_of_response_df(df, schema_df, datamap_schema_df, subject['research_study_uri'], subject['research_study_id'])
    ...
    query = f"""
                ...
                inner join {postgres_table} rs 
                    on ql.response_subject_uri = rs.research_study_uri
            """
