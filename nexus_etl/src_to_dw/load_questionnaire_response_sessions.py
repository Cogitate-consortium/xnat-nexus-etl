...
def main():
    ...
    additional_field = 'research_subject_id, session_type, xnat_custom_fields'
    field_list = f"{subject_id_field}, {subject_uri_field}, {additional_field}"
    ...
    for session_type in session_type_list:
        ...
        form_resource_type = session_type
        ...
        query = f"""
                ...
                where 
                    ...
                    and session_type = '{form_resource_type}'
        ...
        if len(questionnaire_response_df) > 0:
            ...
            query = f"""
                        ...
                        inner join {postgres_table} rs 
                            ...
                            and ql.xnat_data_type = '{session_type}'
                    """
            ...
            response_df_list.append(questionnaire_response_df)

        if len(response_df_list) > 0:
            questionnaire_response_df = pd.concat(response_df_list)
        else:
            questionnaire_response_df = pd.DataFrame()
