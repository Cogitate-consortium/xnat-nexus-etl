...
from dw_dataclasses.questionnaire_list import questionnaire_list
...
postgres_table_name = 'questionnaire_list'
resource_type = 'fhir:Questionnaire'
...
validate_structure(questionnaire_list, df)
...
for index, row in df.iterrows():
    ...
    try:
        nexus_dict = nexus.resources.fetch(org, project, row.questionnaire_uri)
    except:
        nexus_dict = None
