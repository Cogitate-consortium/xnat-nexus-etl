...
from dw_dataclasses.questionnaire_item_list import questionnaire_item_list
...
postgres_table_name = 'questionnaire_item_list'
resource_type = 'fhir:QuestionnaireItemComponent'
...
validate_structure(questionnaire_item_list, df)
...
for index, row in df.iterrows():
    ...
    try:
        nexus_dict = nexus.resources.fetch(org, project, row.questionnaire_item_uri)
    except:
        nexus_dict = None
