...
postgres_table_name = 'acquisition'
resource_type = 'nidm:Acquisition'
...
validate_structure(acquisition, df)
...
for index, row in df.iterrows():
    ...
    try:
        nexus_dict = nexus.resources.fetch(org, project, row.acquisition_uri)
    except:
        nexus_dict = None
